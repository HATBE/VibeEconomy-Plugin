...
public class TextOutput {
	...
	public static final String PREFIX = ChatColor.GRAY + "[" + ChatColor.DARK_PURPLE + "VibeEconomy" + ChatColor.GRAY + "]" + ChatColor.RESET + " ";
	public static final String PLAIN_PREFIX = "[VibeEconomy] ";
